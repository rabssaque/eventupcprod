...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210304_eventosupc_c3081480f03052aa4527_20210304043110_archive.zip';
	const ARCHIVE_SIZE		 = '674504';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'c308148-04043110';
    const SECONDARY_PACKAGE_HASH = '6bfef27-04043110';
	const VERSION			 = '1.4.0';
