...
$rocket_cookie_hash = '0ca2861472f149b5aef852f946493837';
$rocket_logged_in_cookie = 'wordpress_logged_in_0ca2861472f149b5aef852f946493837';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_secret_cache_key = '5ff481c0c28ba989705014';
$rocket_cache_mobile = 1;
$rocket_do_caching_mobile_files = 0;
$rocket_cache_webp = 0;
$rocket_cache_ssl = 1;
$rocket_cache_reject_uri = '/(.+/)?feed/?.+/?|/(?:.+/)?embed/|/finalizar-compra/(.*)|/carrito/|/mi-cuenta/(.*)|/wc-api/v(.*)|/(index\.php/)?wp\-json(/.*|$)';
